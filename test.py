...
messages_by_groups = ds.command(commands.GetMessagesByGroups(start_timestamp=START_TIME,end_timestamp=END_TIME,book_id="case3",groups=["Case030","Case031","Case032","arfq02dc30","arfq02fix30","csvtest1"]))
